                ...
                <Panel title='How To Play on The Iron Throne'>
                    ...
                    <div className='htp-topic'>
                        ...
                        <ul>
                            ...
                            <li>/token t x - Sets the token count of a card of type 't' to 'x'. Currently used token types are: 'bell', betrayal', 'ear', 'ghost', 'gold', 'jail', 'journey', 'kiss', 'poison', 'prayer', 'stand', 'tale', 'valarmorghulis', 'vengeance' and 'venom'.</li>
