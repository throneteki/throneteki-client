    ...
    render() {
        ...
        return (
            <div className='col-xs-12 full-height'>
                <Panel title={t('How To Play on The Iron Throne')}>
                    <a
                    ...
                    <ul className='htp-main-list font-weight-bold mb-3'>
                        ...
                        <li>
                            <a href='#interactions'>
                                <Trans>Specific Card Interactions</Trans>
                            </a>
                        </li>
                        <ul className='htp-sub-list'>
                            <li>
                                <a href='#riddle'>
                                    <Trans>Varys' Riddle vs Summer Harvest</Trans>
                                </a>
                            </li>
                        </ul>
                        <li>
                    ...
                    <p>
                        <Trans i18nKey='howtoplay.addingdecks'>
                            Start by making sure you have created an account and are logged in. You
                            ...
                            <a
                                target='_blank'
                                href='http://www.thronesdb.com'
                                rel='noopener noreferrer'
                            >
                                ThronesDB
                            </a>{' '}
                            deckbuilder to build their decks. After building your deck on ThronesDB
                            download it as a TXT file, then copy and paste it into the deckbuilder
                            here. You are now ready to start playing. Head over to the{' '}
                    ...
                    <h4 className='htp-subtitle' id='action'>
                        <Trans>Action Windows</Trans>
                    </h4>
                    <p>
                        Thrones 2nd Edition has quite a large number of phases and their associated
                        action windows, a number of which are not used regularly by all decks.
                        Always prompting these action windows leads to a lot of tediously clicking
                        ‘Pass’, while never prompting these action windows leads to certain cards
                        not being able to be used to their fullest extent. To solve this issue you
                        can check/uncheck any action windows in your profile to determine when
                    ...
                    <h4 className='htp-subtitle' id='timed'>
                        <Trans>Timed Interrupt Window</Trans>
                    </h4>
                    <p>
                        ...
                        opponent might hold in his hand. For example: if after playing an event
                        there is a pause before it resolves, you might guess correctly that was due
                        to your opponent being prompted to use The Hand’s Judgment. The three most
                        notable cards that would be leaked this way are{' '}
                        <a
                            target='_blank'
                        ...
                        . To solve this issue, the Timed Interrupt Window was created. Depending on
                        which options you have checked, you get a timed prompt during certain
                        triggers asking for interrupts whether you are able to interrupt these
                        triggers or not. Now your opponent experiences the same pause any time and
                        won’t be able to correctly guess whether you’re holding certain cards
                        anymore.
                    </p>
                    <p>
                        There are a couple of options: you can decide whether you want to always be
                        prompted for triggered card abilities (useful if you’re playing Treachery),
                        events (useful if you’re playing The Hand’s Judgment, The Pack Survives,
                        etc.) or both. Claim (useful if you’re playing Vengeance for Elia) is
                        currently combined with the event option. The timer duration can be modified
                        too. Obviously, if you don’t care about leaking cards from your hand (or you
                        don’t play these cards anyway) and just want a quick game, deselecting both
                        options will allow for that. You will still get prompted to use the
                        aforementioned cards, but only when you actually have them.
                    </p>
                    <h3 id='bugs'>
                        <Trans>Bugs and Automation</Trans>
                    </h3>
                    ...
                    <div className='htp-subtopic'>
                        ...
                        <p>
                            ...
                            revealed Varys&apos; Riddle, to make sure your opponent&apos;s value of
                            X will be 2, you have to go first and trigger Summer Harvest first. As
                            the player who revealed Summer Harvest, if the Varys&apos; Riddle player
                            has made you first player (or you won initiative somehow), you&apos;d
                            want to trigger Varys&apos; Riddle first to make sure your X is 7.
                        </p>
                    </div>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            with caution and only when the prompt is 'stuck' and you are unable to
                            continue.
                        </li>
