                ...
                <Panel title='How To Play on The Iron Throne'>
                    ...
                    <div className='htp-topic'>
                        ...
                        <ul>
                            ...
                            <li>/token t x - Sets the token count of a card of type 't' to 'x'. Currently used token types are: 'bell', betrayal', 'blood', 'ear', 'gold', 'kiss', 'poison', 'stand', 'valarmorghulis', 'vengeance' and 'venom'.</li>
                        </ul>
                    </div>
                    <div className='htp-topic'>
