    ...
    render() {
        ...
        const restrictedListDropdown = (
            <RestrictedListDropdown
                currentRestrictedList={this.props.restrictedLists.find(
                    (rl) => rl.name === this.state.defaultRestrictedList
                )}
        ...
        return (
            <div>
                ...
                <form className='form form-horizontal'>
                    ...
                    />
                    <Checkbox
                        name='useDefaultRestrictedList'
                        label='Use default Restricted List'
                        labelClass='col-sm-4'
                        fieldClass='col-sm-offset-3 col-sm-8'
                        onChange={this.onCheckboxChange.bind(this, 'useDefaultRestrictedList')}
                        checked={this.state.useDefaultRestrictedList}
                    />
                    {this.state.useDefaultRestrictedList && (
                        <div className='form-group'>
                            <div className='col-sm-offset-3'>{restrictedListDropdown}</div>
                        </div>
                    )}
                    ...
                    {this.state.useEventGameOptions && (
                        <Checkbox
                            name='useRookery'
                            label='Rookery format'
                            labelClass='col-sm-4'
                            fieldClass='col-sm-offset-3 col-sm-8'
                            onChange={this.onEventGameOptionCheckboxChange.bind(this, 'useRookery')}
                            checked={this.state.eventGameOptions.useRookery}
                        />
                    )}
                    {this.state.useEventGameOptions && (
                        <Checkbox
