...
import ThronesGameSettings from './ThronesGameSettings';
...
import WinterBg from '../../assets/img/bgs/background3.png';
...
const Profile = ({ onSubmit, isLoading }) => {
    ...
    const backgrounds = [
        ...
        { name: 'BG1', label: t('Standard'), imageUrl: StandardBg },
        { name: 'BG2', label: t('Winter'), imageUrl: WinterBg }
    ];
    const cardSizes = [
    ...
    initialValues.windowTimer = user.settings.windowTimer;
    initialValues.promptDupes = user.settings.promptDupes;
    if (user?.settings?.keywordSettings) {
        initialValues.keywordSettings = user.settings.keywordSettings;
    }
    initialValues.promptedActionWindows = user.promptedActionWindows;
        ...
        <Formik
            ...
            onSubmit={async (values) => {
                ...
                const submitValues = {
                    ...
                    settings: {
                        keywordSettings: values.keywordSettings,
                        windowTimer: values.windowTimer,
                        promptDupes: values.promptDupes
                    },
                    promptedActionWindows: values.promptedActionWindows
                };
        ...
        >
            {(formProps) => (
                ...
                >
                    ...
                    <Row>
                        <Col sm='6'>
                            <ActionWindows formProps={formProps} />
                        </Col>
                        <Col sm='6'>
                    ...
                    <Row>
                        ...
                        <Col sm='6'>
                            <ThronesGameSettings formProps={formProps} user={user} />
                        </Col>
                    </Row>
