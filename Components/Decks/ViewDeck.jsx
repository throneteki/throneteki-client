            ...
            <div className='col-sm-7'>
                <Panel title={ deck.name }>
                    <div className='btn-group col-xs-12'>
                        <button className='btn btn-primary' onClick={ this.handleEditClick } disabled={ this.props.deck.eventId ? true : false }>Edit</button>
                        <ConfirmedButton onClick={ this.handleDeleteClick } disabled={ this.props.deck.eventId ? true : false } >Delete</ConfirmedButton>
                    </div>
